<template>
  <div class="bg-white p-6 rounded-lg shadow-md flex flex-col gap-2">
    ...
    <div class="flex space-x-4 mb-6">
      ...
      <button
        class="px-6 py-2 bg-red-100 text-red-600 rounded-lg hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-red-400"
      >
        Tozalash
      </button>
    </div>
        ...
        <tbody>
          ...
          >
            ...
            <td class="py-3 px-4 flex items-center">
              ...
              >
                {{
                  row.miqdor_change > 0 ? "▲" : row.miqdor_change < 0 ? "▼" : ""
                }}
              </span>
              {{ row.miqdor }}
            </td>

<template>
  <div class="flex flex-col gap-4">
    <div class="w-full flex justify-between">
      ...
      <Button variant="destructive" class="">+ Taminotchi</Button>
    </div>
    <div
      class="grid grid-cols-4 grid-rows-3 gap-4 max-sm:max-w-md max-sm:flex max-sm:flex-col"
    >
      <div v-for="n in 8" :key="8" class="max-sm:w-full">
        <a
        ...
        >
          <span
            class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white flex gap-4"
          >
            Urgach MCHJ
          </span>
